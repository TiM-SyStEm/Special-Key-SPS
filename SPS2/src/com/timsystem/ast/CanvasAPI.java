...
public class CanvasAPI {
    ...
    public static void inject() {
        ...
        Functions.set("line", intConsumer4Convert(CanvasAPI::line));
        Functions.set("oval", intConsumer4Convert(CanvasAPI::oval));
        Functions.set("foval", intConsumer4Convert(CanvasAPI::foval));
        Functions.set("rect", intConsumer4Convert(CanvasAPI::rect));
        Functions.set("frect", intConsumer4Convert(CanvasAPI::frect));
        Functions.set("clip", intConsumer4Convert(CanvasAPI::clip));
        Functions.set("drawstr", new DrawText());
    ...
    private static void DrawStr(String str, float x, float y) {
